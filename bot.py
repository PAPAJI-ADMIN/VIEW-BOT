...
async def channel_post_handler(event):
    if event.is_channel:
        ...
        if is_registered:
            ...
            # Place Auto-Order (Cost deducted from channel owner's balance)
            # For simplicity, we assume owner has enough balance or you can modify this logic
            place_smm_order(post_link, AUTO_VIEW_QTY, SMM_PRIVATE_SERVICE_ID)
