...
# ID 20130: Telegram Post Views - Instant Start⚡ (₹1.80/1k)
            ...
            try:
                ...
                if balance >= cost:
                    ...
                    if res and "order" in res:
                        ...
                        await bot.send_message(ADMIN_ID, f"⚠️ **SMM API Error:** {res}")
            except: pass
        return
        ...
        if event.fwd_from:
            try:
                ...
                if hasattr(fid, 'channel_id'):
                    ...
                    await event.respond(f"✅ **Channel Linked!** Auto-views (100 qty) activated.")
            except: pass
            return
