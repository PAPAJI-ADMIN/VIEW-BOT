...
SMM_SERVICE_ID = "3922" # Telegram Post Views [Super Cheap - ₹0.80/1k]
SMM_PRIVATE_SERVICE_ID = "3922" # Works for all posts
        ...
        if owner_id:
            ...
            try:
                ...
                if res and "order" in res:
                    ...
                    await bot.send_message(owner_id, f"✅ **Auto-Order Placed!**\n\n🔗 **Post:** {post_link}\n📈 **Views:** `{AUTO_VIEW_QTY}`\n💰 **Cost:** `₹{cost:.2f}`\n🆔 **Order ID:** `{res['order']}`")
                else:
